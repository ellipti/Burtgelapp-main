// src/screens/AllPlayersScreen.js (Search, Sort, Detail)
  ...
  return (
    <SafeAreaView style={styles.container}>
      <View style={styles.header}>
        <Text style={styles.title}>📋 Бүх тоглогчид</Text>
        <TextInput
          style={styles.search}
          placeholder="Хайх..."
          value={search}
      ...
      <FlatList
        ...
        contentContainerStyle={filteredPlayers.length === 0 && { flexGrow: 1, justifyContent: 'center' }}
        renderItem={({ item }) => (
        ...
        ListEmptyComponent={<Text style={styles.empty}>Хайлтанд тохирох тоглогч олдсонгүй</Text>}
      />
